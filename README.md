...
| 10/06/2024 | 3.1 |  Llamo Amner  |    Documentación de su avance del backend, asi como frontend, con evaluaciones según heurísticas |
| 10/06/2024 | 3.2 | Cantoral Diego  |    Documentación de su avance del backend, siendo la sección de bc-crops, completando los endpoints respectivos |
| 10/06/2024 | 3.3 |  Rivas David  |    Documentación de su avance del backend, siendo la sección de bc-products|
| 10/06/2024| 3.4|  Rivas David, Quispe Godofredo, Guillen Paolo, Diego Cantoral , Amner Llamo|Correciones finales y secciones del student outcome respecto al TB2 al completo, con video sobre el producto así como nuestras entrevistas de validación|
...
|-|:-|-|
|Comunica oralmente con efectividad a diferentes rangos de audiencia |Diego Cantoral: TB1: En esta entrega, investigué detalladamente el problema a solucionar y los distintos métodos para llegar al usuario de manera útil. Esto se logró mediante una descripción adecuada del start-up, así como la creación de user stories relacionadas con la aplicación. TP: Para esta entrega, plasmé las funciones de nuestra aplicación en el front end relacionado con ‘crop information’, mostrando información pertinente y útil al usuario según investigaciones previas. TB2: Desarrollé el back end relacionado con ‘crops’, considerando la lógica de negocio del start-up y las acciones que los usuarios desean realizar. Los endpoints desarrollados en el back end se basaron en las necesidades del usuario, permitiendo interacciones funcionales. TF: En esta entrega, realicé la conexión entre el back end y front end relacionado con el bounded context ‘crop’, asegurando que la información visualizada se guarde adecuadamente para que los usuarios puedan realizar interacciones funcionales. Godofredo Quispe: TB1: En esta entrega, realicé el criterio de Requirements Specification para conocer los puntos a implementar según las necesidades de nuestros usuarios. TP: Para esta entrega del trabajo parcial, me centré en todo lo relacionado con el registro de sesión e inicio de esta, para que los usuarios puedan entrar a nuestra aplicación de manera sencilla y agradable según sus recomendaciones. TB2: Mi rol en esta entrega fue el desarrollo del backend, específicamente el endpoint relacionado con bc-users, tarea que elegí por ser la más adecuada para mí al organizar el sprint. También se implementaron requisitos solicitados por el equipo. TF: En esta fase, validé al usuario para poder registrarse o actualizar sus datos y también implementé Iam para la seguridad de encriptación de la contraseña ingresada por el usuario. Amner Llamo: TB1: En esta entrega, investigué el problema a solucionar y, con esta información, diseñé la aplicación web y la landing page para brindar una buena experiencia a nuestros usuarios. También diseñé la base de datos, los diagramas C4 y apoyé en la creación de historias de usuario. TP: Para esta entrega, desarrollé los componentes del foro de preguntas y respuestas acorde al diseño y la muestra de información planteados en la entrega anterior. TB2: Debido a que faltaban algunas secciones en el frontend, me desempeñé desarrollándolas y avanzando la sección de mi backend de bc-forum con endpoints funcionales. También apoyé con evaluaciones según heurística. TF: La creación de este documento demostró nuestra efectiva comunicación escrita en el equipo. Utilicé varias herramientas como WhatsApp, Discord y los mensajes en los commits de GitHub para compartir mis avances y pedir ayuda cuando la necesité. También incluí actas de nuestras reuniones, útiles para entender y comunicar los acuerdos sobre nuestros objetivos. Paolo Guillen: TB1: En esta entrega, coordiné las actividades de mi equipo, investigué el problema a solucionar en conjunto con mi equipo, y realicé la landing page y el diseño de la carátula de la documentación. TP: Para la entrega del trabajo parcial, comuniqué los avances de forma clara y consistente, respetando los derechos de autor de otros trabajos, y realicé una demostración práctica de nuestro producto hasta ese momento. Aunque considero que pudo haber sido mejor, la comunicación general del proyecto fue efectiva, ya que me desempeñé como líder del equipo. TB2: En el sprint número tres o la entrega del TB2, me desempeñé como líder, comunicando a mis compañeros las partes a realizar y explicando satisfactoriamente el backend desarrollado. TF: En la entrega del trabajo final, realizamos entrevistas de validación previas a la entrega del producto final. Esto ayudó a expandir nuestro producto a nuestro público objetivo y comunicarles cómo nuestro producto podría ayudarlos a cuidar mejor sus cultivos y registrar estos de manera más sencilla. Considero que la explicación del funcionamiento de nuestro proyecto fue satisfactoria. Rivas David: TB1: Como parte de esta entrega, participé como líder del grupo, organizando actividades junto a Paolo y apoyando en la organización del Sprint 1 y la creación de User Stories. También capacité a mis colegas en herramientas como Git y Trello para el ciclo de vida del proyecto, y desempeñé el rol de software manager, asegurando que todos los componentes del proyecto estuvieran alineados con los estándares establecidos. TP: En esta entrega, implementé el apartado CRUD de los cultivos para la gestión del cultivo, incluyendo la creación de interfaces en Angular y el uso de JSON-SERVER, asegurando la comunicación entre diferentes componentes de la aplicación. TB2: Para esta entrega del sprint, desarrollé el backend relacionado con bc-products, enfocado en el registro de productos que el usuario utiliza y su almacenamiento en la base de datos, asegurando la recuperación de información de manera confiable. Demostré estos avances en la exposición, comunicando los logros de cada miembro del equipo y promoviendo una mejora continua para la última entrega. TF: En esta entrega, realicé los últimos cambios a products y su relación con sowings, optimizándolos. También trabajé en la documentación y testing, asegurando que todo estuviera en orden. |TB1: Como equipo, concluimos que el diseño y realización de entrevistas fue esencial para cumplir correctamente con este primer hito. Comunicamos a nuestro segmento objetivo lo que podríamos ofrecer para resolver sus problemas, enfocándonos en el sector agrícola, tanto profesional como amateur. Logramos comunicar el proyecto de forma exitosa, haciendo comprender a diversos rangos de audiencia los beneficios de nuestro producto en desarrollo. TP: La entrega del trabajo parcial se concluyó de forma exitosa gracias a que contábamos con una versión preliminar que los entrevistados ayudaron a probar. Aunque esta no era la mejor versión, recibimos su visto bueno y diversos puntos de mejora, como la implementación de más cultivos. TB2: En la entrega del sprint número tres, finalizamos la aplicación frontend. Las entrevistas de validación fueron excelentes, ya que recibimos feedback positivo y varios entrevistados confirmaron que el producto funciona correctamente, aunque mencionaron que el lenguaje español no estaba completamente implementado. Sin embargo, las funcionalidades y expectativas de los usuarios se cumplieron de forma exitosa. TF: Para el trabajo final, durante nuestra reunión de sprint, comunicamos los diversos aspectos que cada miembro debía cumplir, siendo el más importante integrar su sección del backend con el frontend. Esto se concluyó de forma exitosa, ya que se comunicó al profesor y la exposición fue exitosa y sin fallos.||
|Comunica por escrito con efectividad a diferentes rangos de audiencia|Paolo Guillen: TB1: Para la entrega del primer avance participé en el desarrollo de la landing page, así como en diseñar las entrevistas y realizar algunas. Analicé estas entrevistas y rescaté la información importante para el desarrollo de nuestro producto, estableciendo una base y determinando los requisitos funcionales y no funcionales que nuestros usuarios podrían necesitar, según lo expresado en las entrevistas. TP: En la entrega de trabajo parcial, participé exhaustivamente en la documentación del proyecto, con la intención de cumplir las expectativas para este segundo hito. Para esta entrega, ya teníamos una versión preliminar y funcional de la aplicación web con un fake API, y mi rol fue el desarrollo de la sección de crops del proyecto, actividad que considero realizada de manera satisfactoria. TB2: En la penúltima entrega del trabajo, mi rol fue de líder nuevamente, asignando actividades de documentación y desarrollo de software a mis compañeros. Entre estas actividades se encontraba el desarrollo del API, nuestro backend, que separé en 5 bcs. Todos estos endpoints debían ser documentados para comunicar lo realizado a otros posibles desarrolladores. TF: Para la entrega del trabajo final, me encargué de documentar los endpoints restantes y de terminar la integración entre el backend y el frontend. En el front, dejé pequeños comentarios en el código de mi sección, la cual desarrollé de sowings y sus controles, con el fin de facilitar la lectura a futuros usuarios del proyecto como apoyo. Godofredo Quispe: TB1: En esta entrega me enfoqué en las user stories y documenté las necesidades y requisitos de los usuarios según las entrevistas realizadas. TP: En esta parte, realicé la interfaz de registro y login de usuario, de acuerdo con las necesidades de los usuarios reflejadas en las user stories y recopilando datos de los usuarios respecto a la interfaz. TB2: En esta entrega, me centré en el bounded context de User, detallando las funcionalidades para el registro de usuario y las metas a alcanzar para su creación y consumo de la RestFul API. TF: En esta parte, me enfoqué en la validación de usuario y en la seguridad, encriptando la contraseña y validando aspectos según los requisitos de autenticación de usuario. David Rivas: TB1: En esta entrega se realizaron entrevistas para conocer a los usuarios finales y sus necesidades, las cuales se convirtieron en los pilares de nuestra aplicación. Desempeñé mi rol como software manager, integrando el uso de herramientas para el equipo y documentando cada avance en los commits del informe. TP: Para esta entrega, participé en el diseño e implementación del frontend, específicamente en las secciones de crops, usando componentes de Angular Material para mejorar el estilo visual, documentando esto de manera concisa y clara. TB2: En esta entrega, comenzamos con el backend. Me enfoqué en el módulo bc-products, implementando la interacción con la base de datos y mecanismos de validación para el correcto registro. Documenté cada etapa del desarrollo, incluyendo decisiones y mejoras técnicas en las relaciones entre products y sowings. TF: Se cambió la relación entre products y sowings y se implementó un auditable para auditorías, documentando la decisión tomada. También trabajé en el apartado de testing, documentando las necesidades en esta última entrega tanto en el product backlog como en el informe de cada cambio realizado en el proyecto. Amner Llamno: TB1: Realizamos entrevistas con los segmentos objetivo para recopilar los requisitos necesarios. Me asignaron diseñar la aplicación web para cumplir dichos requisitos y crear los diagramas C4 para la arquitectura de la aplicación. TP: En esta entrega, corregí errores en la documentación y trabajé en el desarrollo preliminar de la sección de foro de nuestra aplicación web. Estoy satisfecho con el resultado logrado en esa área. TB2: En esta entrega, avanzamos con el desarrollo del backend de la aplicación web, completando un 60% del total. Me asignaron desarrollar la sección de foro, que finalicé de manera satisfactoria, y documentar todos los endpoints relacionados. TF: Lo más importante fue lograr la integración entre el backend y el frontend. Me encargué de integrar el bounded context del foro, asegurando que todas las partes funcionaran perfectamente. Realicé varias correcciones basadas en problemas identificados durante la evaluación heurística, mejorando la aplicación para que sea más intuitiva y funcional. Diego Cantoral: TB1: Realicé investigaciones sobre las fases de los cultivos y los efectos externos que pueden modificar el contexto del programa. TP: Implementé funciones relacionadas con la información proporcionada a los usuarios, lograda mediante un frontend que brindaba información pertinente. TB2: Para esta entrega, profundicé en las interacciones del usuario para recolectar adecuadamente la información mediante el desarrollo del backend de crops, pests y diseases. TF: Para esta entrega, integré el backend y frontend relacionados con el bounded context de crops, implementando las lógicas de la aplicación con las interacciones del usuario, asegurando que estas acciones se almacenen adecuadamente.|TB1: En la primera fase del proyecto, el equipo se dedicó a la recopilación de información esencial mediante entrevistas a usuarios finales y la investigación sobre el contexto agrícola del proyecto. Se identificaron los requisitos funcionales y no funcionales necesarios para el desarrollo de la aplicación. Esta etapa permitió establecer una base sólida de conocimientos y objetivos, esenciales para el desarrollo futuro del sistema. TP: Durante la entrega parcial, se avanzó significativamente en el desarrollo y documentación del proyecto. El equipo trabajó en la creación de interfaces de usuario y componentes del frontend, así como en la corrección de errores en la documentación y el desarrollo preliminar de secciones clave de la aplicación web. La colaboración permitió generar una versión preliminar y funcional de la aplicación, utilizando APIs falsas para simular la funcionalidad. TB2: En el segundo avance, el enfoque principal fue la implementación del backend y su integración con el frontend. Se desarrollaron y documentaron múltiples endpoints del API, lo que permitió una comunicación clara y eficiente entre los componentes del sistema. Además, se realizaron ajustes y mejoras en las funcionalidades del sistema para garantizar su correcto funcionamiento. TF: Para la entrega final, el equipo se centró en la integración completa del backend con el frontend y en la finalización de la documentación. Se aseguró que la integración fuera fluida y que la documentación estuviera detallada y accesible, facilitando la comprensión y el mantenimiento del sistema por parte de futuros desarrolladores. Los comentarios en el código y la documentación detallada son elementos clave que contribuirán a la continuidad y mejora del proyecto. Por lo tanto, la conclusión general es la siguiente: a lo largo de todas las fases del proyecto, el equipo mostró una excelente colaboración y dedicación. La efectiva división del trabajo y el compromiso con los objetivos permitieron cumplir con los hitos establecidos. El resultado es una aplicación funcional y bien documentada que responde a las necesidades identificadas de los usuarios finales. Este enfoque colaborativo y detallado asegura que el sistema pueda ser fácilmente entendido y mejorado por futuros desarrolladores, cumpliendo con las expectativas de una audiencia técnica diversa.|
...
<img src="resources/impactMap.png"/>
...
Enlace del video: [https://youtu.be/NrzBO_7Q6rY]
...
| `/crops/diseases`       | CRUD para las enfermedades asociados con cultivos. Se obtienen id, cultivo, nombre, descripción y solución. Por ejemplo, "Bacterial stain" (id: 1) afecta a "Rice" y se controla con fungicidas de cobre.                                                                                                                                                   |
| `/crops/products`       | CRUD para los productos. Se obtienen id, siembra, fecha, tipo, nombre y cantidad. Por ejemplo, para la siembra 1, el 25/07/2024 se usaron 10 kg de "Aminofol Plus".                                                                                                                                                                                         |
| `forum/questions`       | Se implementaron las opciones de CRUD de las cuáles se puede evidenciar el funcionamiento de estos de manera local, así como desde un json-server almacenado en "my-json-server.typicode", además del getQuestions desde el Placeholder Json para la tabla de las preguntas que se han registrado dentro de la sección de forum.                              |
| `forum/answers`         | Se implementaron las opciones de CRUD de las cuáles se puede evidenciar el funcionamiento de estos de manera local, así como desde un json-server almacenado en "my-json-server.typicode", además de los getAnswers desde el Placeholder Json para la tabla de las respuestas de acuerdo a la pregunta que el usuario se encuentre interesado en saber más información. |
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>GET</td>
      <td>{userId}</td>
      <td>api/v1/forum/questions/user/{userId}</td>
    </tr>
    <tr>
      <td>GET</td>
      <td>{questionId}</td>
    ...
    <tr>
      ...
      <td>api/v1/subscription/{subscriptionId}</td>
    </tr>
    <tr>
      <td>PUT</td>
      <td>{subscriptionId}</td>
    ...
    <tr>
      <td>GET</td>
      <td>{sowingId}</td>
      <td>api/v1/sowings/{sowingId}/products</td>
    </tr>
    <tr>
      <td>POST</td>
      <td>{sowingId}</td>
    ...
    <tr>
      <td>GET</td>
      <td>No tiene</td>
      <td>api/v1/sowings/controls</td>
    </tr>
    <tr>
      <td>DELETE</td>
      <td>{sowingId}, {productId}</td>
      <td>api/v1/sowings/{sowingId}/products/{productId}</td>
    </tr>
    <tr>
      <td rowspan="3">Pests</td>
    </tr>
    <tr>
      <td>GET</td>
      <td>No tiene</td>
    ...
    <tr>
      <td>GET</td>
      <td>{countryId}</td>
      <td>api/v1/country/{countryId}</td>
    </tr>
    <tr>
      <td>PUT</td>
      <td>{countryId}</td>
    ...
    <tr>
      <td rowspan="8">UserProfile</td>
    </tr>
    <tr>
      <td>GET</td>
      <td>{userProfileId}</td>
      <td>api/v1/userProfile/{userProfileId}</td>
    </tr>
    <tr>
      <td>PUT</td>
      <td>{userProfileId}</td>
    ...
    <tr>
      <td>GET</td>
      <td>{userProfileEmail}, {userProfilePassword}</td>
      <td>api/v1/userProfile/{userProfileEmail}/{userProfilePassword}</td>
    </tr>
    <tr>
      <td rowspan="3">Cares</td>
    </tr>
    <tr>
      <td>GET</td>
      <td>No tiene</td>
...
| :-: | :- |
|<img src="resources/entrevistasValidacionFotos/Seis.png">|<p>Durante la entrevista, mencionó que le parece una idea estupenda la creación de una plataforma como Chaquitaclla, la cual ayudará y revolucionará la manera de vivir de muchas personas</p><p>Asimismo, indicó que cada herramienta presentada en la plataforma es interesante, especialmente la sección Forum.</p><p>Destacó que esta sección es de gran ayuda para principiantes como él y que será una herramienta valiosa que muchos utilizarán para compartir información.<p/>|
|Timing: 22:56-34:03 |URL:[https://upcedupe-my.sharepoint.com/:v:/g/personal/u202124343_upc_edu_pe/ERYvAIYclxdHjFiasENtOkUBX7HOQk37lqprQRNFwMS0Iw?e=Pq4Gfg&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifSwicGxheWJhY2tPcHRpb25zIjp7InN0YXJ0VGltZUluU2Vjb25kcyI6MTM3Ni44NH19] |
...
<img src="resources/heuristicas/diseases.png"><br>
...
* **VideoTB2:** [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202124343_upc_edu_pe/EfEF3gOhaQpIq4mW-XTcf44BdjGRI9f4agmZGEs66LI62Q?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=0yAZMr]
