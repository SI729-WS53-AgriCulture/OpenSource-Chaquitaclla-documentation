      ...
      <table border="1">
        <thead>
            ...
            <tr>
                ...
                <td>HU01</td>
                <td>Usuario: </td>
                <td> Cliente Desarrollador</td>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>Nombre HU:</td>
                <td colspan="3">Registrarme</td>
            </tr>
            <tr>
                <td>Prioridad en el Negocio:</td>
                <td>Alta</td>
                <td>Riesgo en desarrollo:</td>
                <td>Alto</td>
            </tr>
            <tr>
                <td>Horas estimadas:</td>
                <td>20</td>
                <td>Iteración asignada:</td>
                <td>Sprint x</td>
            </tr>
            <tr>
                <td>Nombre HU:</td>
            ...
            <tr> 
                <td>Actividades claves del usuario: </td>
                <td colspan="3">'rol'</td>
            </tr>
            <tr> 
                <td>Descripción: </td>
                <td colspan="3">'que hara en la web'</td>
            </tr>
            <tr>
                <td rowspan="2">Criterios de aceptación:</td>
                <td colspan="3">Escenario 1</td>
            </tr>
            <tr>
